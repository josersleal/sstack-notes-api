...
api keys:
  None
endpoints:
  POST - https://0sf683f572.execute-api.eu-west-1.amazonaws.com/prod/notes
  GET - https://0sf683f572.execute-api.eu-west-1.amazonaws.com/prod/notes/{id}
  GET - https://0sf683f572.execute-api.eu-west-1.amazonaws.com/prod/notes
  PUT - https://0sf683f572.execute-api.eu-west-1.amazonaws.com/prod/notes/{id}
  DELETE - https://0sf683f572.execute-api.eu-west-1.amazonaws.com/prod/notes/{id}
functions:
